...
namespace DelegatesLinQ.Homework
{
    ...
    public class CalculationLogger
    {
        ...
        {
            Console.WriteLine($"[ERROR LOG] Operation: {operation}, Error: {errorMessage}");
        }
    }
    ...
    public class CalculationAuditor
    {
        ...
        {
            Console.WriteLine($"[AUDITOR] Total successful operations: {_operationCount}");
        }
    }
    ...
    public class ErrorHandler
    {
        ...
        public void OnErrorOccurred(string operation, string errorMessage)
        {
            ...
            Console.WriteLine($"[ERROR HANDLER] Operation '{operation}' failed: {errorMessage}");
            Console.ResetColor();
        }
    }
